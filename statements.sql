...
-- select nombre, apellido, count(lenguaje) as cantidad_lenguajes from usuarios_lenguajes group by nombre, apellido;
...
-- select nombre, apellido, edad, (edad - (select avg(edad) from usuarios_lenguajes)) as diferencia_promedio from usuarios_lenguajes;
